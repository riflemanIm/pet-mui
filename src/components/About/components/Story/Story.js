      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          <Typography component={"p"} color={"text.secondary"} fontWeight={400}>
            Компания Shepherd Pet предлагает кома и лакомства, которые помогут
            не просто коримить, но и дрессировать Вашего питомца. Мы помогаем
            более 100 клиентам каждый месяц находить информацию, необходимую им
            для обеспечения наилучшей жизни своим питомцам. Наша команда
            авторов, в которую входят тренеры, зарегистрированные ветеринарные
            ...
            многолетнего практического опыта для питания и дресировки.
          </Typography>
        </Grid> */}

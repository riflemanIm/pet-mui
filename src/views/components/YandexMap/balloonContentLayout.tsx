...
${
  d.email
    ? `<div class=${gridItem1}><svg class=${icon(
        theme
      )} focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="EmailIcon">       
...
<div class=${gridItem2}><span class=${body(theme)}>${d.email}</span></div>`
    : ""
}


${
  d.www && typeof d.www === "string"
    ? `<div class=${gridItem1}><svg class=${icon(
        theme
      )} focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="wwwIcon">       
...
<div class=${gridItem2}><span class=${body(theme)}><a href="${
        d.www
      }" target="_blank" >
      ${d.www.replace(/(^\w+:|^)\/\//, "")}</a></span></div>`
    : ""
}

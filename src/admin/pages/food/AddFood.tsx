...
const AddFood = () => {
  ...
  const setField = React.useCallback(
    <K extends keyof AddFoodForm>(key: K, value: AddFoodForm[K]) => {
  ...
  const onNum =
    (key: keyof AddFoodForm) => (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <Grid2 size={{ xs: 12, md: 6 }}>
          <Stack spacing={2}>
            ...
            <HtmlEditor
              ...
              onChange={(html) => setField("annotation", html)}
            />
            ...
            <SingleDict
              ...
              options={refs.taste}
              value={form.tasteId}
              onChange={(id) => setField("tasteId", id)}
            />
            <SingleDict
              label="Ингредиент"
            ...
            <SingleDict
              ...
              onChange={(id) => setField("hardnessId", id)}
            />
        ...
        <Grid2 size={12}>
          <Stack spacing={2}>
            ...
            <MultiDict
              ...
              options={refs.ages}
              value={form.ageIds}
              onChange={(ids) => setField("ageIds", ids)}
            />
            <MultiDict
              label="Тип лакомств"
            ...
            <MultiDict
              ...
              onChange={(ids) => setField("packageIds", ids)}
            />
            <MultiDict
              label="Особые нужды"

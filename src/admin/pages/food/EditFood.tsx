...
const EditFood = () => {
  ...
  const onStr = (k: string) => (e: React.ChangeEvent<HTMLInputElement>) =>
    ...
    <Widget>
      <Grid2 container spacing={3}>
        ...
        <Grid2 size={{ xs: 12, md: 6 }}>
          <Stack spacing={2}>
            <TextField
              label="Артикул"
              value={form.artikul}
              onChange={onStr("artikul")}
            />
            <TextField
              label="Название"
              value={form.title}
              onChange={onStr("title")}
            />
            <TextField
              select
              label="Тип"
            ...
            <Stack direction="row" spacing={2}>
              <FormControlLabel
                control={
                  <Switch checked={!!form.vat} onChange={onBool("vat")} />
                }
                label="НДС"
              />
              <FormControlLabel
            ...
            <TextField
              label="Ozon ID"
              value={form.ozonId}
              onChange={onStr("ozonId")}
            />
            <TextField
              label="Img URL"
              value={form.imgUrl}
              onChange={onStr("imgUrl")}
            />
          </Stack>
        </Grid2>
        ...
        <Grid2 size={{ xs: 12, md: 6 }}>
          <Stack spacing={2}>
            <TextField
              label="Короткое описание (feature)"
              value={form.feature}
              onChange={onStr("feature")}
            />
        ...
        <Grid2 size={12}>
          <Stack spacing={2}>
            ...
            <MultiDict
              ...
              onChange={(ids) => set("petSizeIds", ids)}
            />
            <MultiDict
              label="Упаковки"
        ...
        <Grid2 size={12}>
          ...
          <Grid2 container spacing={2}>
            <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              ...
              <ImageField
                value={form.img1 || null}
                onFileSelect={setImg1File}
                onClear={() => set("img1", null)}
              />
            </Grid2>
            <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              <Typography variant="caption">Изображение 2</Typography>
              <ImageField
                value={form.img2 || null}
                onFileSelect={setImg2File}
                onClear={() => set("img2", null)}
              />
            </Grid2>
            <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              <Typography variant="caption">Изображение 3</Typography>
              <ImageField
                value={form.img3 || null}
                onFileSelect={setImg3File}
                onClear={() => set("img3", null)}
              />
            </Grid2>
            <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              <Typography variant="caption">Изображение 4</Typography>
              <ImageField
                value={form.img4 || null}
                onFileSelect={setImg4File}
                onClear={() => set("img4", null)}
              />
            </Grid2>
            ...
            <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              ...
              <ImageField
                value={form.img5 || null}
                onFileSelect={setImg5File}
                onClear={() => set("img5", null)}
              />
            </Grid2>
            <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              <Typography variant="caption">Изображение 6</Typography>
              <ImageField
                value={form.img6 || null}
                onFileSelect={setImg6File}
                onClear={() => set("img6", null)}
              />
            </Grid2>
            <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              <Typography variant="caption">Изображение 7</Typography>
              <ImageField
                value={form.img7 || null}
                onFileSelect={setImg7File}
                onClear={() => set("img7", null)}
              />
            </Grid2>
            <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              <Typography variant="caption">Изображение 8</Typography>
              <ImageField
                value={form.img8 || null}
                onFileSelect={setImg8File}
                onClear={() => set("img8", null)}
              />
            </Grid2>
            ...
            <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              ...
              <ImageField
                value={form.img9 || null}
                onFileSelect={setImg9File}
                onClear={() => set("img9", null)}
              />
            </Grid2>
            <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              <Typography variant="caption">Изображение 10</Typography>
              <ImageField
                value={form.img10 || null}
                onFileSelect={setImg10File}
                onClear={() => set("img10", null)}
              />
            </Grid2>
          </Grid2>
        </Grid2>
